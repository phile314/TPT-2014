...
normalizableStep (AppL f f' x s) n = {! Normalizable {!   !} (Clapp f x) !}
normalizableStep (Beta body v) n = {!   !}
normalizableStep Lookup n = {!   !}
normalizableStep Dist n = {!   !}

normalizableSteps : forall {ty} -> {c1 c2 : Closed ty} -> Steps c1 c2 -> Normalizable ty c2 -> Normalizable ty c1
normalizableSteps Nil n = {! !}
normalizableSteps (Cons x steps) n = {! normalizableStep x n :: normalizableSteps steps n !}
